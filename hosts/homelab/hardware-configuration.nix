...
in {
  ...
  boot.kernelParams = ["default_hugepagesz=1G" "hugepagesz=1G" "hugepages=64" "amd_pstate=active" "amd_pstate.shared_mem=1" "pci=realloc" "pcie_acs_override=downstream,multifunction"];
