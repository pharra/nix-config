{
  ...
  testHas = manufacturer:
    ...
    then false
    else if builtins.isString cfg.manufacturer
    then cfg.manufacturer == manufacturer
    else if builtins.isList cfg.manufacturer
    then builtins.elem manufacturer cfg.manufacturer
    else false;
